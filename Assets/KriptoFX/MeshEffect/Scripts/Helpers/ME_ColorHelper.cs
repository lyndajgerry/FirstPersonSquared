...
public static class ME_ColorHelper
{
    ...
    public static void ChangeObjectColorByHUE(GameObject go, float hue)
    {
        ...
        //var ME_shaderColorGradients = go.GetComponentsInChildren<RFX1_ShaderColorGradient>(true);
        
        //foreach (var ME_shaderColorGradient in ME_shaderColorGradients)
        //{
        //    ME_shaderColorGradient.HUE = hue;
        //}
