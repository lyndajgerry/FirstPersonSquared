...
namespace Byn.Unity.Examples
{
    ...
    public class ConferenceApp : MonoBehaviour
    {
        ...
        private string mSignalingUrl = "wss://signaling.because-why-not.com/conferenceapp";

        /// <summary>
        /// ice server server. Used to get trough the firewall and establish direct connections.
        /// </summary>
        private IceServer mIceServer = new IceServer("turn:turn.because-why-not.com:443", "testuser14", "pass14");
        ...
        /// <summary>
        /// Log handler for logs sent by the external dll's
        /// </summary>
